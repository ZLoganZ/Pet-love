...
public class LoaiThuCungServiceImpl implements LoaiThuCungService{
    ...
    public LoaiThuCung createLoaiThuCung(LoaiThuCungDTO DTO) {
        ...
        if(loaiThuCungRepository.findByMaLoaiThuCung(DTO.getMaLoaiThuCung().trim().toUpperCase())){
    ...
    public LoaiThuCung updateLoaiThuCung(String id, LoaiThuCungDTO DTO) {
        ...
        if (!loaiThuCung.getMaLoaiThuCung().equalsIgnoreCase(DTO.getMaLoaiThuCung().trim()) && loaiThuCungRepository.findByMaLoaiThuCung(DTO.getMaLoaiThuCung().trim().toUpperCase())) {
